...
class LegacyLogin_Ee2UserDataRecord extends BaseRecord
{
	...
	protected function defineAttributes()
	{
		return array(
			...
			'last_forum_post_date' => array(AttributeType::Number, 'required' => false),
			...
			'daylight_savings' => array(AttributeType::String, 'required' => false),
			'localization_is_site_default' => array(AttributeType::String, 'required' => false),
